...
model = Sequential([
    ...
    Conv2D(32, (3, 3), activation='relu', input_shape=(IMG_SIZE, IMG_SIZE, 1), kernel_regularizer=l1(0.001)),
    ...
    Dropout(0.3),  #Dropout after pooling layer to prevent overfitting
    #Convolution layer with 64 filters of 3x3
    Conv2D(64, (3, 3), activation='relu', kernel_regularizer=l1(0.001)), #Penalizes large weights and reduces overfitting
    BatchNormalization(),
    MaxPooling2D((2, 2)),
    Dropout(0.3),  
    ...
    Conv2D(256, (3, 3), activation='relu', kernel_regularizer=l1(0.001)),
    BatchNormalization(),
    MaxPooling2D((2, 2)),
    Dropout(0.3), 
    ...
    Dense(2, activation='softmax', kernel_regularizer=l1(0.001))
])
